...
public class JwtAuthentificationFilterTest {
    ...
    private static final String KNOWN_EMAIL = "john.doe@example.com";
    ...
    public void test_doFilterInternal_validJwt_authenticatesAndContinues() throws Exception {
        ...
        when(jwtService.validateTokenAndGetUsername("valid.jwt.token")).thenReturn(KNOWN_EMAIL);
        User user = new User();
        user.setEmail(KNOWN_EMAIL);
        when(userRepository.findByEmail(KNOWN_EMAIL)).thenReturn(Optional.of(user));
    ...
    public void test_doFilterInternal_validJwtButUserNotFound_returnsException() throws Exception {
        ...
        when(jwtService.validateTokenAndGetUsername("valid.jwt.token")).thenReturn(UNKNOWN_EMAIL);
        when(userRepository.findByEmail(UNKNOWN_EMAIL))
